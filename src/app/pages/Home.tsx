    ...
    <div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="bg-white/10 hover:bg-white/20 text-white border-white/30">
              <Link to="/signup/expert">전문가로 등록하기</Link>
            </Button>
          </div>
          <div className="mt-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  기업 실태 조사 및 진단을 전문가가 정확하게 수행합니다.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-teal-600 text-white rounded-full flex items-center justify-center">
                    1
                  </div>
                  <div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="mb-2">의뢰 공고 작성 및 게시</h3>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="mb-2">공고 확인 및 입찰</h3>
                    <p className="text-gray-600">등록된 공고를 확인하고 가격을 입찰합니다.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-green-600 text-white rounded-full flex items-center justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="text-center">
              <CardHeader>
                <DollarSign className="h-12 w-12 text-teal-600 mb-4 mx-auto" />
            ...
            <Card className="text-center">
              <CardHeader>
                <CheckCircle2 className="h-12 w-12 text-teal-600 mb-4 mx-auto" />
            ...
            <Card className="text-center">
              <CardHeader>
                <Users className="h-12 w-12 text-teal-600 mb-4 mx-auto" />
            ...
            <Card className="text-center">
              <CardHeader>
                <Building2 className="h-12 w-12 text-teal-600 mb-4 mx-auto" />
      ...
      <section className="py-16 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-teal-100">
            간편한 가입으로 ProToCall 서비스를 이용해보세요.
          </p>
          <Button asChild size="lg" variant="secondary">
